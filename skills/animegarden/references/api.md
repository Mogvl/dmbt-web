...
- `$ANIMEGARDEN_API_BASE`, default `http://localhost:9701` (your self-hosted
  AnimeGarden instance; see repo README for Docker Compose deployment)
...
- Example:
  ...
  ```bash
  curl '${ANIMEGARDEN_API_BASE:-http://localhost:9701}/'
  ```
...
- Example:
  ...
  ```bash
  curl '${ANIMEGARDEN_API_BASE:-http://localhost:9701}/resources?search=%E8%91%AC%E9%80%81%E7%9A%84%E8%8A%99%E8%8E%89%E8%8E%B2&keyword=1080p&keyword=%E7%AE%80%E4%BD%93%E5%86%85%E5%B5%8C&type=%E5%8A%A8%E7%94%BB&page=1&pageSize=30'
  ```
...
- Example:
  ...
  ```bash
  curl '${ANIMEGARDEN_API_BASE:-http://localhost:9701}/detail/dmhy/123456'
  ```
...
- Example:
  ...
  ```bash
  curl '${ANIMEGARDEN_API_BASE:-http://localhost:9701}/users'
  ```
...
- Example:
  ...
  ```bash
  curl '${ANIMEGARDEN_API_BASE:-http://localhost:9701}/teams'
  ```
...
- Example:
  ...
  ```bash
  curl '${ANIMEGARDEN_API_BASE:-http://localhost:9701}/subjects'
  ```
